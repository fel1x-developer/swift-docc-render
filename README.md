...
> Note: requires the latest LTS version of [Node.js](https://nodejs.org/en/download/)
> and [npm](https://www.npmjs.com/package/npm). An easy way to set these up is to install
> [nvm](https://github.com/nvm-sh/nvm) and run `nvm install --lts` from within the Swift-DocC-Render
